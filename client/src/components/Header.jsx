...
const Header = () => {
    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 md:mt-8'>
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 
                        border border-purple-400 bg-purple-100 rounded-full text-sm text-purple-600'>
  ...
  <button  
    type="submit" 
    className='bg-blue-600 text-white px-8 py-2 hover:scale-105 transition-all cursor-pointer'
  >
    Search
  </button>
</form>
...
<div className='text-center'>
 {
 input && <button onClick={onClear} className="border font-light text-xs py-1 px-3 rounded-sm shadow-custom-sm cursor-pointer mt-4">
  Clear Search</button>}
</div>
      <img 
